...
<head>
  ...
  <title>SIDMAT | Maputo Cidade</title>
...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="{{route('Home')}}" class="brand-link">
      ...
      <span class="brand-text font-weight-light"><b>SIDMAT</b></span>
    </a>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{route('Home-request')}}" class="nav-link">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{route('Home-stock')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p><b>Stock</b></p>
                </a>
              </li>
          ...
          <li class="nav-header">Atalhos</li>
          <li class="nav-item">
            <a href="{{route('Home-calendar')}}" class="nav-link">
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; 2023 <a href="">ccsaude.org.mz</a>.</strong>
    All rights reserved.

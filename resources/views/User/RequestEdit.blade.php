                        ...
                        <form class="form-horizontal">
                            <div class="card-body">
                                <div class="form-group row">
                                    <label for="inputEmail3" class="col-sm-3 col-form-label">Descrição do
                                        Material</label>
                                    <div class="col-sm-10">
                                ...
                                <div class="form-group">
                                    <label for="standard-select">Unidade Sanitária (2)</label>
                                    <div class="select">
                                        <select id="standard-select">
                                ...
                                <div class="form-group">
                                    <label for="standard-select">Unidade Sanitária (3)</label>
                                    <div class="select">
                                        <select id="standard-select">
                                            <option value="Option 1">Selecione</option>
                                            <option value="Option 2">Option 2</option>
                                ...
                                <div class="form-group">
                                    <label for="standard-select">Unidade Sanitária (4)</label>
                                    <div class="select">
                                        <select id="standard-select">
                                            <option value="Option 1">Selecione</option>
                                            <option value="Option 2">Option 2</option>
